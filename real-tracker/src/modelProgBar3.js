...
const ProgBar = () => {
  ...
  useEffect(() => {
    async function fetchMaxPercentageOAN() {
      try {
        const response = await axios.get('http://localhost:5000/maxPercentageOAN3'); // Use Axios for GET request
  ...
  useEffect(() => {
    async function fetchTotalBlocks() {
      try {
        const response = await axios.get('http://localhost:5000/totalBlocks3'); // Use Axios for GET request
  ...
  useEffect(() => {
    async function fetchPlacedBlocks() {
      try {
        const response = await axios.get('http://localhost:5000/placedBlocks3'); // Use Axios for GET request
